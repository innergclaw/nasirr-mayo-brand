...
revoke all on function public.claim_innerg_sunday_id() from anon;
revoke all on function public.get_free_innerg_id_record() from anon;
revoke all on function public.update_free_innerg_id_name(text, text) from anon;
